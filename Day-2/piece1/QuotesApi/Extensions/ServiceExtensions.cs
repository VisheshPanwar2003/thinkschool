...
public static class ServiceExtensions
{
    ...
    public static IEndpointRouteBuilder MapQuoteEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapPost("/", async (CreateQuoteRequest req, IQuoteRepository repo, IClock clock, IQuoteFormatter formatter, ILogger<Program> logger, CancellationToken ct) =>
        {
            ...
            var quote = new Quote { Author = req.Author.Trim(), Text = req.Text.Trim(), CreatedAt = clock.UtcNow };
