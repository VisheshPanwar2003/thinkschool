...
// FIX 1: Explicitly tell the app to listen on port 8080 on all network interfaces
...
// FIX 2: Prevent the database connection from blocking the server startup
try 
{
...
{
    app.Logger.LogError(ex, "Database connection failed on startup. The web server will continue running.");
}
